...
namespace Dating4U.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,FirstName,LastName,Age,Gender,Description,Hobby,ProfilePicture")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,FirstName,LastName,Age,Gender,Description,Hobby,ProfilePicture")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
